...
2. summer dev days
    - structuring workshops and planning sessions
    - core dev yearly meeting agenda - updates, info, decision items
    - list of "good issues" for sprint
    - intern presentations
    - contributed presentations, spotlight call
    - going forward (after event) action tony to share access to sktime email with CC; create eventbrite account with that email 
3. Interns
4. JMLR software paper
5. Funding model
