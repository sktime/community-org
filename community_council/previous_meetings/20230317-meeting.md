...
Note B: this is correct as minuted! This is a confusing response, in direct contradiction to MR's request to share the decision in public. ML is seemingly ignoring MR's request, and responds as if MR had instead asked for the decision to be shared in private.
